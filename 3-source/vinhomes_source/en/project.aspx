                    ...
                    <ItemTemplate>
                        <div class="col-md-3 col-xs-4 element-item">
                            <div class="project-box text-center">
                                <a href='<%# progressTitle(Eval("ProjectTitleEn")) + "-pri-" + Eval("ProjectID") + ".aspx" %>' class="project-img">
                                ...
                                <h4 class="project-name">
                                    <a href='<%# progressTitle(Eval("ProjectTitleEn")) + "-pri-" + Eval("ProjectID") + ".aspx" %>'><%# Eval("ProjectTitleEn")%></a></h4>
