<%@ Page Title="" Language="C#" MasterPageFile="~/en/site-project.master" AutoEventWireup="true"
...
<asp:Content ID="Content2" ContentPlaceHolderID="cpSite" runat="Server">
    <div id="site">
        ...
        </span></a><a href="project.aspx">Project <span class="glyphicon glyphicon-triangle-right"></span>
        </a><span>
