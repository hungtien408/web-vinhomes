<%@ Page Title="" Language="C#" MasterPageFile="~/en/site.master" AutoEventWireup="true"
    CodeFile="news-1.aspx.cs" Inherits="project" %>
                    ...
                    <ItemTemplate>
                        <div class="col-md-3 col-xs-4 element-item">
                            <div class="project-box text-center">
                                <a href='<%# progressTitle(Eval("ArticleTitleEn")) + "-tri-" + Eval("ArticleID") + ".aspx" %>' class="project-img">
                                ...
                                <h4 class="project-name">
                                    <a href='<%# progressTitle(Eval("ArticleTitleEn")) + "-tri-" + Eval("ArticleID") + ".aspx" %>'><%# Eval("ArticleTitleEn")%></a></h4>
